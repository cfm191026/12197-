...
#define ENC_R_PGO_Pin GPIO_PIN_1
#define ENC_R_PGO_GPIO_Port GPIOB
#define DIR_R_Pin GPIO_PIN_2
...
#define ENC_L_PGO_Pin GPIO_PIN_8
#define ENC_L_PGO_GPIO_Port GPIOB
